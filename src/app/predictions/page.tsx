    ...
    <main className="min-h-screen bg-zinc-950 text-white">
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          {globalMessage && (
            <div className="rounded-3xl border border-[#3CAC3B]/30 bg-[#3CAC3B]/10 p-4 text-[#D1D4D1] shadow-lg shadow-[#3CAC3B]/10">
                          ...
                          >
                            ...
                            <div className="mt-5">
                              {prediction.editing ? (
                                ...
                                <div className="rounded-3xl bg-[#474A4A] px-4 py-5 text-center text-4xl font-bold text-white">
                                  {teamItem.score}
                                </div>
                              )}
                            </div>
